  ...
  return (
    ...
    >
      ...
      <LegalSection title="Paid membership and automatic renewal">
        ...
        <p>You can stop future renewal online from <strong className="text-foreground">Profile → Membership → Cancel renewal</strong>. Cancellation stops the next automatic charge and ordinarily leaves paid access available through the end of the current paid period. You can also open Stripe billing settings from the Membership page.</p>
        <p>Where a platform requires its own payment system, purchases made through that platform may also be governed by the platform&apos;s own purchase, renewal, cancellation, and refund rules.</p>
      </LegalSection>
      ...
      <LegalSection title="Copyright complaints">
        <p>If you believe content on Tellwise infringes your copyright or other intellectual-property rights, email <a className="underline underline-offset-4" href="mailto:tellwiseapp@gmail.com">tellwiseapp@gmail.com</a> with enough information to identify the work, the allegedly infringing material, your contact information, and the basis for your request. Tellwise may remove content while a complaint is reviewed.</p>
      </LegalSection>
      ...
      <LegalSection title="Contact">
        <p>Questions about these terms, or any questions or requests generally, can be sent to <a className="underline underline-offset-4" href="mailto:tellwiseapp@gmail.com">tellwiseapp@gmail.com</a>.</p>
      </LegalSection>
    </LegalPage>
  )
}
