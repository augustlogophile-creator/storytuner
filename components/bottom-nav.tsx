...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Primary" className="fixed bottom-0 left-1/2 z-40 w-full max-w-[25rem] -translate-x-1/2 border-t border-border bg-background/94 backdrop-blur-xl">
      <ul className="flex items-stretch justify-between px-1 pb-[max(.5rem,env(safe-area-inset-bottom))] pt-2">
