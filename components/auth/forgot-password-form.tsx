  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      <label className="block">
        <span className="text-[0.56rem] font-semibold uppercase tracking-[0.11em] text-muted-foreground">Email</span>
      ...
      {message && <p role="status" className="rounded-xl border border-border bg-secondary/45 px-4 py-3 text-sm leading-relaxed">{message}</p>}
      <button type="submit" disabled={loading} className="flex w-full items-center justify-center gap-2 rounded-full bg-primary px-5 py-2.5 text-[0.8rem] font-medium text-primary-foreground disabled:opacity-50">
