    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="rounded-3xl border border-border bg-card p-5">
        <div className="flex items-start gap-3">
          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-brand-soft text-accent-foreground">
            <Mail className="h-5 w-5" />
          </span>
          <div>
            <Eyebrow>Support</Eyebrow>
            <h2 className="mt-1 text-base font-semibold">Questions, issues, or concerns?</h2>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Reach out anytime. We can help with your account, recordings, lessons, or anything else in StoryTuner.
            </p>
          </div>
        </div>
        <a
          href="mailto:storytunerapp@gmail.com"
